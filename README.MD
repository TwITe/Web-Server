...
Принимает на вход тип запрашиваемого хэдера. В случае существования хэдера такого типа возвращает данный типа **http_header**, иначе - возвращает пустой хэдер

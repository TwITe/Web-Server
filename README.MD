...
5) **get_request_url()**, **get_request_method()**, **get_request_http_version()**
...
1) **set_response_code(int code)**
Метод принимает на вход код ответа типа *int* и устанавливает его

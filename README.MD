...
Data
| General requests statistics:	 | Go	       |C++     |
| -------------------------------|-------------|--------|
| Average response time:	     | 3,946145	   |8,033418|
| Response time median:	         | 1,592826	   |2,534091|
| Response time 95th percentile: |	14,897673  |31,28058|

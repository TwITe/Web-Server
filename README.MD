...
Принимает на вход тип запрашиваемого хэдера. В случае существования хэдера такого типа возвращает данный хэдер в виду **http_header**,
иначе - возвращает пустой хэдер

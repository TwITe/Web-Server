...
TEST_CASE("GetProperWebHandler_RequestPOSTW/oParametersW/oPathW/Slash_ReceivedPostRequestHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
...
TEST_CASE("GetProperWebHandler_RequestPOSTW/oParametersW/oPathW/oSlash_ReceivedPostRequestHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
...
TEST_CASE("GetProperWebHandler_RequestPOSTW/ParametersW/oPathW/Slash_ReceivedPostRequestHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
...
TEST_CASE("GetProperWebHandler_RequestPOSTW/ParametersW/oPathW/oSlash_ReceivedPostRequestHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
...
TEST_CASE("NonexistentProperWebHandler_RequestGETBadMethod_ReceiveErrorHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
...
TEST_CASE("NonexistentProperWebHandler_RequestGETBadPattern_ReceiveErrorHandler", "HTTP Router") {
    vector<webserver::web_handler> handlers;
    ...
    webserver::http_request test_request;
    test_request.set_http_request_method("POST");
    test_request.set_http_request_url("https://vk.com/feed");
